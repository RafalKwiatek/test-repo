...
path = file.path("~/Text Mining/TM", "text-data", "text-tm-2")
length(dir(path))
dir(path)
...
path <- file.path("C:/Users/rafal/Dropbox/!datascience/R/PWTextMining/tm-lab-final/","text-data", "SMSSpamCollection.txt")
smsSpamCollection <- readLines(path,warn=FALSE)
#as a parameter you can also use url link
summary(smsSpamCollection)
corpus1 <- Corpus(VectorSource(smsSpamCollection)) 
inspect(corpus1)
summary(corpus1)
...
##Sentiment Analysis
hu.liu.pos = scan(file.path("~/Text Mining/TM", "text-data", "opinion-lexicon-English","positive-words.txt"),
                  what='character', comment.char=';')
hu.liu.neg = scan(file.path("~/Text Mining/TM", "text-data", "opinion-lexicon-English","negative-words.txt"),
                  what='character', comment.char=';')
...
getwd()
write.table(sou2010, file.path("C:/Users/rafal/Dropbox/!datascience/R/PWTextMining/tm-lab-final/text-data", "text-tm-2","sou2010_1.txt"))
...
name = file.path("C:/Users/rafal/Dropbox/!datascience/R/PWTextMining/tm-lab-final/text-data", "text-tm-2")
length(dir(name))
dir(name)
...
#KNN
library(class)
path <- file.path("C:/Users/rafal/Dropbox/!datascience/R/PWTextMining/tm-lab-final", "text-data", "spambase","spambase.data")
...
sms_raw <- read.csv(file.path("C:/Users/rafal/Dropbox/!datascience/R/PWTextMining/tm-lab-final", "text-data","sms_spam.csv"), stringsAsFactors = FALSE)
